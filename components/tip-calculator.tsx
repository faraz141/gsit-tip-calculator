...
export default function TipCalculator() {
  ...
  return (
    <div
      ...
      style={{
        background: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.5)), url("/images/background.jpg") no-repeat center center/cover`,
      }}
    >
      <Card className="w-full max-w-md p-6 bg-white opacity-85 dark:bg-gray-800 shadow-lg rounded-lg">
        <CardHeader>
